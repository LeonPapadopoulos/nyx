...
namespace Nyx
{
    namespace Engine
    {
        ...
        void WindowsWindow::Initialize(const WindowSpecs & specs)
        {
            ...
            glfwSetFramebufferSizeCallback(Window, [](GLFWwindow* window, int width, int height)
                {
                    ...
                    self->VulkanHandler->OnFramebufferResized();
                });

            SetVSync(true);

            ASSERT(glfwVulkanSupported() && "Currently only Vulkan is supported.");
            Renderer = Nyx::Renderer::CreateRenderer();
            ...
            ImGui = new Nyx::Renderer::ImGuiVulkanUtil(Window, VulkanHandler);
            ImGui->Initialize(
        ...
        void WindowsWindow::SetupVulkan()
        {
            ...
            VulkanHandler = new Nyx::Renderer::VulkanUtil();
